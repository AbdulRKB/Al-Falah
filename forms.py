...
class LoginForm(Form):
    username = StringField('Username*', [validators.Length(min=5, max=100), validators.DataRequired()], render_kw={"placeholder": "Enter Username"})
    password = PasswordField('Password*', [validators.Length(min=5, max=100), validators.DataRequired()], render_kw={"placeholder": "Enter Password"})
